...
namespace Rengifo_Alexander_MVC_Code_First.Controllers
{
    public class EstudianteUdlasController : Controller
    {
        private readonly Rengifo_Alexander_MVC_Code_FirstContext _context;

        public EstudianteUdlasController(Rengifo_Alexander_MVC_Code_FirstContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdBanner,Nombre,FechaNacimiento")] EstudianteUdla estudianteUdla)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdBanner,Nombre,FechaNacimiento")] EstudianteUdla estudianteUdla)
        {
